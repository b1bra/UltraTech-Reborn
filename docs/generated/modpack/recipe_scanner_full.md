...
Special: 0
JSON files: 0
Class files scanned: 103
```

Recipe classes:

```text
pl/asie/lib/tweak/CraftingTweaker.class
```
...
Special: 0
JSON files: 0
Class files scanned: 15
```

Recipe classes:

```text
com/gamerforea/avaritianei/network/OverlayExtremeFakeRecipeMessage$Handler.class
```
...
Special: 0
JSON files: 0
Class files scanned: 399
```

Recipe classes:

```text
betterquesting/core/BetterQuesting.class
```
...
Special: 0
JSON files: 0
Class files scanned: 43
```

Recipe classes:

```text
glassmaker/extratic/ExtraTiC.class
glassmaker/extratic/common/RecipeHandler.class
```
...
Special: 0
JSON files: 0
Class files scanned: 65
```

Recipe classes:

```text
gravisuite/GraviSuite.class
```
...
Special: 0
JSON files: 0
Class files scanned: 1282
```

Recipe classes:

```text
net/loliland/lolidimensions/registries/LDRecipes.class
```
...
loliland/draconicevo/integration/minetweaker/recipe/MTSoulTransformer.class
```
...
Special: 0
JSON files: 0
Class files scanned: 205
```

Recipe classes:

```text
loliland/forestry/integration/minetweaker/recipe/MTBeeFactory.class
```
...
Special: 0
JSON files: 0
Class files scanned: 891
```

Recipe classes:

```text
loliland/utility/obf/l1lO1iI1LaND.class
```
...
Special: 0
JSON files: 0
Class files scanned: 101
```

Recipe classes:

```text
mantle/utils/RecipeRemover.class
mantle/utils/CraftingHandler.class
```
...
Special: 0
JSON files: 0
Class files scanned: 372
```

Recipe classes:

```text
com/gamerforea/mpp/common/recipe/StaticRecipeCache$KeySet.class
```
...
Special: 0
JSON files: 0
Class files scanned: 9
```

Recipe classes:

```text
com/creativemd/opf/OPFrame.class
```
...
Special: 0
JSON files: 0
Class files scanned: 27
```

Recipe classes:

```text
putils/common/PowerUtils.class
```
...
Special: 0
JSON files: 0
Class files scanned: 143
```

Recipe classes:

```text
loliland/redpower/common/core/ModItem.class
```
...
```text
wanion/lib/recipe/advanced/AbstractRecipeRegistry.class
```
...
Special: 0
JSON files: 0
Class files scanned: 1688
```

Recipe classes:

```text
loliland/luminous/ui/recipe/LoliRecipeViewerScreen.class
loliland/luminous/ui/recipe/LoliRecipeViewerScreen$buildRecipeGrid$2$1$7.class
loliland/luminous/ui/recipe/LoliRecipeViewerScreen$buildRecipeGrid$2$1$2.class
```
